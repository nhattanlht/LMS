...
import { faEdit, faTrash, faDownload, faPencilAlt, faEye, faBell, faPlus, faComment, faStickyNote} from "@fortawesome/free-solid-svg-icons";
          ...
          <div className="course-description">
            ...
            <div className="course-header">
              ...
              <div className="course-info">
                <p>
                  Start:{" "}
                  {new Date(course.startTime).toLocaleDateString("en-GB", { timeZone: "UTC" })}
                </p>
                <p>
                  End:{" "}
                  {new Date(course.endTime).toLocaleDateString("en-GB", { timeZone: "UTC" })}
                </p>
            ...
            >
             <FontAwesomeIcon icon={faEye} className="white-icon" /> <p>View Grade</p>
            </button>
            </div>
            </div>
            )}
            ...
            <div className="col">
             ...
             <p><FontAwesomeIcon icon={faComment} />  Discussion Forum </p>
              ...
              <div className="col">
                ...
                {role === "L" && (
                  <div className="course-links">
                    ...
                    >
                       <FontAwesomeIcon icon={faPlus} className="white-icon" /> <p>Upload New File</p>
                    </button>
                  </div>
                )}
                <ul>
              ...
              <div className="col">
                ...
                {role === "L" && (
                  <div className="course-links">
                    ...
                    >
                       <FontAwesomeIcon icon={faPlus} className="white-icon" /> <p>Add New Assignment</p>
                    </button>
                  </div>
                )}
              </div>
              ...
              <div className="col">
                ...
                {role === "L" && (
                  <div className="course-links">
                    ...
                    >
                      <FontAwesomeIcon icon={faPlus} className="white-icon" /> <p>Add New Test</p>
                    </button>
                  </div>
                )}
              </div>
            ...
            {showUploadModal && (
              <div className="modal">
                <div className="modal-content">
                  ...
                  <button className="close-btn" onClick={handleUploadFile}>Upload</button>
            ...
            {showEditResourceModal && editResource && (
              <div className="modal">
                <div className="modal-content">
                  ...
                  <button onClick={() => setShowEditResourceModal(false)}>Cancel</button>
                </div>
              </div>
            )}
          </div>
